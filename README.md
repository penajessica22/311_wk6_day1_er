...
- actors can be in any film, and film can contain any amount of actors.
...
- 3 different foreign keys, when you hover over the "payments" table, three high-lighted keys show a connection to two other tables.
##### ER Diagram upload
